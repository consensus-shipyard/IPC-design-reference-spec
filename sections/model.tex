...
% We do not make a general statement about the fault tolerance of \nameAbbr as a system, as to how many faulty processes the system can sustain.
...
We precisely define the replicas and the \nameAbbr agent (all of them being processes) in \Cref{sec:components,sec:smr}.
