...
\TODO{Go through and address remaining Marko's comments of this section} 
...
\paragraph{\PofsFull.}\del{To this end}\add{To enable interaction between subnets}, we define a \emph{\pofFull (\pof)} to be data that proves that an SMR system definitively reached a certain replicated state.
